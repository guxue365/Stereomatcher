...
\usepackage{amsfonts}                  %TeX fonts from the American Mathematical 
\usepackage{multicol}
...
\input{doc/commands}                   %insert file with self-defined commands. The file exists and contains many examples.
...
% - - - - - - - - - - - - - - -
 \mainmatter                       %import chapters (tip: use one tex-file for each chapter)
    \input{doc/imageprocessing.tex}
    \input{doc/calibration.tex}
    \input{doc/backgroundsubtraction.tex}
    \input{doc/stereocomputation.tex}
    \input{doc/segmentation.tex}
    \input{doc/classification.tex}
    \input{doc/datasets.tex}
    \input{doc/evaluation_background.tex}
    \input{doc/evaluation_stereo.tex}
    \input{doc/car_detection.tex}
